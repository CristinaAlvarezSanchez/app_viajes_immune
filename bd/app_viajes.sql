CREATE DATABASE  IF NOT EXISTS `app_viajes` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `app_viajes`;
...
CREATE TABLE `tbi_clientes_viajes` (
  ...
  CONSTRAINT `fk_clientes_has_viajes_clientes1` FOREIGN KEY (`fk_cliente`) REFERENCES `clientes` (`id`),
  CONSTRAINT `fk_clientes_has_viajes_viajes1` FOREIGN KEY (`fk_viaje`) REFERENCES `viajes` (`id`)
...
INSERT INTO `tbi_clientes_viajes` VALUES (1,1,8),(2,2,7),(3,3,6),(4,4,5),(5,5,4),(6,6,3),(7,7,2),(8,8,1);
...
INSERT INTO `viajes` VALUES (1,'2023-07-23','2023-08-02','IB3345','IB3221',1),(2,'2023-07-18','2023-08-28','NTA7765','AGI8756',1),(3,'2023-03-29','2023-03-31','HRR7765','APO8876',2),(4,'2023-02-13','2023-03-05','AXG8767','VVB8769',3),(5,'2022-12-13','2024-02-20','RTW765','SRX8867',4),(6,'2023-07-25','2023-09-20','PCO8878','MXZ8879',4),(7,'2023-06-22','2023-07-15','KZR9898','MGC9878',1),(8,'2023-02-02','2023-03-01','IRZ8987','TEV8768',2);
...
-- Dump completed on 2023-01-20 21:21:00
